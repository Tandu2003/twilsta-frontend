...
// Props interface cho RegisterForm
  ...
  return (
    <Card className='border-border/50 shadow-lg'>
      <CardHeader className='text-center'>
        <CardTitle className='text-foreground text-2xl font-bold'>Tạo Tài Khoản</CardTitle>
        <CardDescription className='text-muted-foreground'>
          Tham gia Twilsta và bắt đầu chia sẻ câu chuyện của bạn
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className='space-y-6'>
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              ...
              <Input
                ...
                className={`bg-input border-border focus:ring-ring pl-8 ${
        ...
        <div className='relative'>
          ...
          <span className='bg-card text-muted-foreground absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform px-3 text-sm'>
            hoặc
          </span>
        </div>
